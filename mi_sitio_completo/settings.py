"""
Django settings for mi_sitio_completo project.
...
SECRET_KEY = 'django-insecure-kiqz@oo6g6^o(jyrahal1_l84)_!an_#u_aaey&y0(xlq71#qp'
...
ROOT_URLCONF = 'mi_sitio_completo.urls'
...
WSGI_APPLICATION = 'mi_sitio_completo.wsgi.application'
